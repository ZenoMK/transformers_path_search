...
python run_gpt_train.py --train --epochs 30 --config ../config/exp_1head_1layer.json --train_file ../data/train.txt --val_file ../data/val.txt --device cpu

python run_validation.py --config ../config/exp_1head_1layer.json --model_file ../models/exp_1head_1layer.pth --train_file ../data/train.txt --val_file ../data/val.txt --dag_file ../data/dag.gpickle
