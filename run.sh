...
python run_validation.py --config ../config/exp_3head_2layer.json --model_file ../models/exp_3head_2layer.pth --train_file ../data/train.txt --val_file ../data/val.txt --dag_file ../data/dag.gpickle
